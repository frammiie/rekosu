...
function Mapper(props: MapperProps) {
  return (
...
function Controls(props: ControlsProps) {
  return (
    <div class='my-[20px] flex gap-[5px]'>
      <AnchorButton
      ...
      <AnchorButton href={`osu://b/${props.beatmap.id}`}>
...
function AnchorButton(props: ParentProps & Pick<AnchorProps, 'href'>) {
  return (
    <A
      href={props.href}
      target='_blank'
      class='h-[45px] p-[10px] bg-[#0005] hover:bg-[#0007] transition-colors text-xs font-medium flex items-center justify-center rounded-md backdrop-blur-sm'
    >
